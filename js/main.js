$(document).ready(function() {
    ...
    // add text to fancybox
    attrFancy = function() {
        $('.block_photo').each(function(){
            $that = $(this);
            var text = $that.find('.block_photo__text span').text();
            $that.find('.fancybox-text').attr('data-title', text);
        });
    }
